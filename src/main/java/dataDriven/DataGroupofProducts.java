...
public class DataGroupofProducts {
	static String projectPath;
	static XSSFWorkbook workbook;
	static XSSFSheet sheet;
	

	public DataGroupofProducts(String excelPath, String sheetName) {

		try {

			projectPath=System.getProperty("user.dir");
			workbook = new XSSFWorkbook(projectPath+"/data/GroupofProducts.xlsx");
